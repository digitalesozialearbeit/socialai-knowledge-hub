...
AI Literacy zusammengefasst, der die Fähigkeit beschreibt, grundlegendes Wissen über KI zu erwerben, deren Funktionsweisen zu verstehen und kritisch reflektieren zu können [^ailiteracies2].

***Anmerkung DHC:*** Der am 08.07. ergänzte Satz oberhalb beginnt unvollständig („AI Literacy zusammengefasst, der …") – vermutlich ist beim Einfügen der Satzanfang verloren gegangen, bitte vervollständigen. Zeilenumbruch mitten im Wort und Fußnoten-Einzug wurden am 10.07. technisch repariert.
...
Für die Software-Schicht um das Modell herum hat sich der Begriff **AI Harness** (auch Agent Harness, engl. harness = Geschirr) etabliert: die Umgebung, die dem Modell Werkzeuge, Kontextverwaltung und Ablaufsteuerung „anlegt" und so aus dem reinen Modell ein handlungsfähiges System macht. Wie stark der Harness das Ergebnis prägt, zeigt sich daran, dass dasselbe Modell in einem gut gebauten Harness (z.B. einem agentischen Coding-Tool mit Datei- und Suchzugriff) Aufgaben lösen kann, an denen es als bloßes Frage-Antwort-Modell scheitert. Bewertungen wie „Modell X kann Y nicht" sagen deshalb oft mehr über den Harness als über das Modell aus.
...
[^divide]: Susanne Sackl-Sharif, Andrea Mayr & Sabine Klinger (2024). Zwischen Digital Divide und kreativ-transformativer Gestaltung des digitalen Raums. Zur Arbeit mit Adressat:innen in der digitalisierten Sozialen Arbeit. In: K. Lauermann, R. More, M. Sigot & S. Sting (Hrsg.): Soziale Arbeit zwischen Inklusion und Exklusion. Perspektiven aus Forschung und Praxis. Opladen/Berlin/Toronto: Barbara Budrich Verlag, S. 142-152.
...
[^geschlecht]: Theresa Wobbe & Gertrud Nunner-Winkler (2020). Geschlecht und Gesellschaft. In: Lehrbuch der Soziologie, 4. Auflage. Frankfurt am Main: Campus Verlag, S. 407-438.
...
[^gaig]: Digital Gender Gap – Schwerpunkt 2026 Künstliche Intelligenz, ein Kooperationsprojekt der Initiative D21 und des Instituts für Arbeitsmarkt- und Berufsforschung (IAB).
