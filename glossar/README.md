...
**A** · [AI Act / KI-Verordnung](#ai-act--ki-verordnung) · [AI Agents / Agentic AI](#ai-agents--agentic-ai) · [AI Literacies / KI Literacies / KI Kompetenzen](#ai-literacies--ki-literacies--ki-kompetenzen) · [Alignment](#alignment) · [Andozentrismus](#andozentrismus) · [API](#api) · [Autoregressive Generierung](#autoregressive-generierung) · [Automation Bias](#automation-bias-in-bias-integrieren) · [Automatisierte Entscheidungsfindung](#automatisierte-entscheidungsfindindung) **B** · [Benchmark](#benchmark) · [Bias](#bias) **C** · [Chancengerechtigkeit](#chancengerechtigkeit) · [Chain of Thought](#chain-of-thought) · [Chatbot](#chatbot) · [Constitutional AI](#constitutional-ai) · [Context / Kontext (technisch)](#context--kontext-technisch) · [Context / Kontext (sozialwissenschaftlich)](#context--kontext-sozialwissenschaftlich) **D** · [Datenschutz / DSGVO](#datenschutz--dsgvo) · [Deskilling](#deskilling) · [Digital Divide](#digital-divide) · [Diversität](#diversität) · [Diversitätssensibilität](#diversitätssensibilität) · [Diskriminierung](#diskriminierung) · [Distillation](#distillation) **E** · [Embedding](#embedding) · [Explainable AI (XAI)](#explainable-ai-xai) **F** · [Fairness (im KI-Kontext)](#fairness-im-ki-kontext) · [Feminist AI Literacies](#feminist-ai-literacies) · [Few-Shot Prompting](#few-shot-prompting) · [Fine-Tuning](#fine-tuning) · [Frontier Model](#frontier-model) **G** · [Geschlecht / Gender](#geschlecht--gender) · [Gender Scripts](#gender-scripts) · [Guardrails](#guardrails) **H** · [Halluzination](#halluzination) · [Heteronormativität](#heteronormativität) · [Human in the Loop / on the Loop / in command](#human-in-the-loop--on-the-loop--in-command) **I** · [Intersektionalität](#intersektionalität) · [I-Methodology](#i-methodology) **J** · [Jailbreaking](#jailbreaking) **K** · [Knowledge Cutoff](#knowledge-cutoff) · [Konfabulation](#konfabulation) **L** · [LLM](#llm) · [LLM as a Judge](#llm-as-a-judge) **M** · [Matthäus-Effekt](#matthäus-effekt) · [MCP](#mcp) · [Menschliche Aufsicht / Human Oversight](#menschliche-aufsicht--human-oversight) · [Mind Perception](#mind-perception) · [Multimodalität](#multimodalität) **N** · [Next Token Prediction](#next-token-prediction) **O** · [Open Source / Open Weights](#open-source--open-weights) **P** · [Post-Training](#post-training) · [Pre-Training](#pre-training) · [Probabilistische Systeme](#probabilistische-systeme) · [Prompt Brittleness](#prompt-brittleness) · [Prompt Engineering](#prompt-engineering) · [Prompt Injection](#prompt-injection) · [Promptotyping](#promptotyping) **Q** · [Queer Feminismus](#queer-feminismus) · [Quantisierung](#quantisierung) **R** · [RAG](#rag) · [Reasoning Modell](#reasoning-modell) · [RLHF](#rlhf) **S** · [Shadow AI](#shadow-ai) · [Slop](#slop) · [Soziale Arbeit](#soziale-arbeit) · [Soziale Ungleichheit](#soziale-ungleichheit) · [Stereotype](#stereotype) · [Stochastic Parrot](#stochastic-parrot) · [Sycophancy](#sycophancy) · [System Prompt](#system-prompt) **T** · [Temperatur](#temperatur) · [Token](#token) · [Tokenizer](#tokenizer) · [Transformer](#transformer) · [Transparenz](#transparenz) **V** · [Vertrauenswürdige / menschenzentrierte KI](#vertrauenswürdige--menschenzentrierte-ki) · [Vulnerabilität / Schutzbedürfnis](#vulnerabilität--schutzbedürfnis)
...
Kontext ist im Bezug auf Diskriminierung, Fairness, Chancengerechtigkeit und co. auch aus sozialwissenschaftlicher Perspektive sehr wichtig, da je nach Zeitpunkt und Ort unterschiedliche Normen, Werte sowie Ungleichheitsfaktoren eine Rolle spielen.
...
- **Human-out-of-the-loop (HOOTL)**: Das System operiert vollständig autonom, ohne menschlichen Input und ohne Eingriffsmöglichkeit während der Ausführung. Menschen haben das System ggf. entworfen und parametriert, sind am laufenden Betrieb aber nicht beteiligt.

**Human in command (HIC)**: HIC bezeichnet die umfassendste Form menschlicher Aufsicht. Sie bezieht sich nicht nur auf die einzelne Entscheidung des Systems, sondern auf dessen Einbettung insgesamt – einschließlich der übergeordneten ökonomischen, gesellschaftlichen, rechtlichen und ethischen Folgen sowie der grundsätzlichen Entscheidung, ob und in welchem Kontext das System überhaupt eingesetzt wird. HIC ist die umfassendste Form der Aufsicht, die über das unmittelbare Funktionieren des KI-Systems hinausgeht und breitere wirtschaftliche, soziale, rechtliche und ethische Auswirkungen berücksichtigt; die Aufsicht kann sich sogar auf die Gesellschaft insgesamt erstrecken. Während HITL und HOTL technische Kontrollmodi am laufenden System beschreiben (Freigabe pro Entscheidung bzw. überwachendes Eingreifen), liegt HIC eine Ebene höher und umfasst die gesamte Steuerungs-, Entscheidungs- und Verantwortungsarchitektur – inklusive Politik-, Design- und Einsatzentscheidungen. In der EU-AI-Act-nahen Auslegung heißt das konkret: Human-in-command gibt Menschen die Befugnis, Richtlinien festzulegen, Stichproben zu prüfen und Ausnahmen zu behandeln, ohne jede einzelne Entscheidung zu kontrollieren.
...
- **rechtliche Besonderheiten**: Das Recht definiert diese Konzepte nicht eigens und legt sie gewissen Verpflichtungen eher implizit zugrunde. Ein Beispiel wäre die [Menschliche Aufsicht / Human Oversight](#menschliche-aufsicht--human-oversight) nach Art 14 KI-VO sowie das Verbot automatisierter Entscheidungsfindungen nach Art 22 DSGVO, in denen sich der Zugang ausdrückt, dass Menschen stets das letzte Wort in maschinenengesetützten Entscheidungsprozessen haben sollten. 
